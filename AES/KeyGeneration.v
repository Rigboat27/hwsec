...
module KeyGeneration(rc,key,keyout);
   ...
   wire [31:0] w0,w1,w2,w3,tem;
       ...
       sbox a1(.sboxIn(w3[23:16]),.sboxOut(tem[31:24]));
       sbox a2(.sboxIn(w3[15:8]),.sboxOut(tem[23:16]));
       sbox a3(.sboxIn(w3[7:0]),.sboxOut(tem[15:8]));
       sbox a4(.sboxIn(w3[31:24]),.sboxOut(tem[7:0]));
